...
* **상명대학교 정보보안공학과 3인 협업 프로젝트**
* **곽지현 (Me)**: FastAPI 기반 실시간 탐지 웹 서비스 개발 및 DeBERTa 모델 추가 학습
* **팀원 1**: DeBERTa-v3-Large 기반 악성 URL 탐지 모델 설계 및 메인 학습
* **팀원 2**: 데이터 전처리 및 정규화 알고리즘 설계 및 오탐·미탐 URL 전수 검수
* **공동 작업**: 178만 건 대규모 데이터셋 수집
